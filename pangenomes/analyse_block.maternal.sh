...
INPUT_VCF="${CACTUS_RESULTS_DIR}/PAN027.${CHR}.project_PAN027_mat/PAN027.${CHR}.project_PAN027_mat.wave.vcf.gz"
GBZ="${CACTUS_RESULTS_DIR}/PAN027.${CHR}.project_PAN027_mat/PAN027.${CHR}.project_PAN027_mat.gbz"
OUTPUT_VCF="${OUTPUT_DIR}/PAN027.${CHR}.project_PAN027_mat.wave.filtered.vcf"
OUTPUT_VCF_UNFILTERED="${OUTPUT_DIR}/PAN027.${CHR}.project_PAN027_mat.wave.unfiltered.vcf"
# ============================================================
