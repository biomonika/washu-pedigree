...
CHR="${1:?Usage: $0 <chromosome>  e.g.  $0 chr1}"
...
BLOCKS="${BLOCKS_DIR}/${CHR}.tsv"
INPUT_VCF="${CACTUS_RESULTS_DIR}/PAN027.${CHR}.project_PAN027_pat/PAN027.${CHR}.project_PAN027_pat.wave.vcf.gz"
GBZ="${CACTUS_RESULTS_DIR}/PAN027.${CHR}.project_PAN027_pat/PAN027.${CHR}.project_PAN027_pat.gbz"
OUTPUT_VCF="${OUTPUT_DIR}/PAN027.${CHR}.project_PAN027_pat.wave.filtered.vcf"
OUTPUT_VCF_UNFILTERED="${OUTPUT_DIR}/PAN027.${CHR}.project_PAN027_pat.wave.unfiltered.vcf"
# ============================================================
