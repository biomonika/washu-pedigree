...
def match_and_create_output(pan027_file, PAN010_haplotype1_file, PAN010_haplotype2_file, PAN028_haplotype1_file, PAN028_haplotype2_file, output_file):
    # Load data from the PAN027 file
    pan027_data = process_file(pan027_file)
    first_dict = process_file(PAN010_haplotype1_file)
    second_dict = process_file(PAN010_haplotype2_file)
...
if __name__ == "__main__":
    ...
    pan027_file = "maternal.PAN027.blocks.maternal.bed.lifted.lifted.bed"
    PAN010_haplotype1_file = "maternal.PAN010.blocks.haplotype1.bed.lifted.lifted.bed"
    PAN010_haplotype2_file = "maternal.PAN010.blocks.haplotype2.bed.lifted.lifted.bed"
    PAN028_haplotype1_file = "maternal.PAN028.blocks.haplotype1.bed.lifted.lifted.bed"
    PAN028_haplotype2_file = "maternal.PAN028.blocks.haplotype2.bed.lifted.lifted.bed"

    # Output file
    output_file = "maternal.blocks.projected.tsv"

    # Run the matching and output creation
    match_and_create_output(pan027_file, PAN010_haplotype1_file, PAN010_haplotype2_file, PAN028_haplotype1_file, PAN028_haplotype2_file, output_file)
