...
- **Purpose**: Parse pairwise alignments generated by the Stretcher tool and extract mismatch and gap information into TSV file.
...
- **Purpose**: Reformat TSV output from `stretcher_parser.py` by collapsing consecutive positions into single lines for easier analysis.
